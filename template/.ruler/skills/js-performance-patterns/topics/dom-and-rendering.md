...
Frontend-only patterns for the browser tier (commonly `apps/web`): batching DOM reads/writes to avoid layout thrashing, and syncing visual updates to the render cycle.
